...
>
> 🎨 **U35g's ASSET IS DONE AND USER-CONFIRMED, 2026-08-17** - *"asset looks good"* - modelled in
> Blender, placed between PC4 and PC6 on a new street of its own, on the map as 🚗. `df0d9fc`. **The
> feature is PLANNED, not built** - nine numbered steps in the U35g section below, plus the census
> the user asked for (the four cars paint; the bike, the cruiser and the aircraft do not). Its
> spec changed mid-model: **the car does not drive in** - approach → shutter rolls up → colour menu
> → drive off repainted. **NEXT ACTION on U35g: build step ④-1..8, one checkpoint.**
>
...
### U35g, 2026-08-17 - the auto shop: ASSET DONE AND USER-CONFIRMED, FEATURE PLANNED - `df0d9fc`
