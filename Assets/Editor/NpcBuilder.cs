...
namespace TheBlock.EditorTools
{
    ...
    public static class NpcBuilder
    {
        ...
        public static string Build()
        {
            ...
            // U35a's rig is written into the very prefabs this method has just replaced, so it is
            // rebuilt here rather than left to be remembered. U34 is the precedent and the warning:
            // CrashSensor went fourteen units attached to nothing because a prefab that carried it
            // was regenerated by a builder that did not know to put it back.
            if (built > 0) log.AppendLine(RagdollBuilder.Build());
